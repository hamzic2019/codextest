...
const translations = {
  bs: {
    ...
    "planner.generating.overlayBody": "Kompjuterski slagalica za smjene: balansiramo dane i noći, čistimo preklapanja i pripremamo finalni raspored.",
  ...
  en: {
    ...
    "planner.generating.overlayBody": "Balancing day and night shifts, resolving overlaps and assembling the schedule - this takes only a few seconds.",
  ...
  de: {
    ...
    "planner.generate.periodLabel": "Zeitraum",
    "planner.generate.prevMonth": "Vorheriger Monat",
    "planner.generate.nextMonth": "Nächster Monat",
    ...
    "planner.generating.overlayBody": "Wir balancieren Tag- und Nachtdienste, lösen Überschneidungen und setzen den Dienstplan zusammen - gleich ist es fertig.",
